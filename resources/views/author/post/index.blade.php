...
@section('content')
        <div class="container-fluid">
            <div class="block-header">
              <a class="btn btn-primary waves-effect"  href="{{ route('author.post.create')}}"><i class="material-icons">add</i>
                <span> Add Post</span>
              </a>
            </div>
                                      ...
                                      @foreach ($posts as $key => $post)
                                        ...
                                        <tr>
                                          ...
                                          <button class="btn btn-danger waves-effect" type="button" onclick="deletePost({{ $post->id }})">
                                            ...
                                            <form id="delete-form-{{ $post->id }}" style="display: none;" action="{{ route('author.post.destroy', $post->id) }}" method="post">
                                              @csrf
                                              @method('DELETE');
                                          </form>
                                        </td>
