...
@section('content')
  <div class="container-fluid">
    <a href="{{route('admin.post.index')}}"><button class="btn btn-danger wave-effects">BACK</button></a>
      @if ($post->is_aproved==false)
        <button type="button" class="btn btn-success pull-right wave-effects" onclick="aprovePost({{ $post->id }})">
